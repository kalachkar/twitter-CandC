descriptionToSymbol = 	{
				...
				"<Emoji: Smiling face with open mouth and smiling eyes>" : "😄",
				"<Emoji: Rolling on the floor laughing>" : "🤣",
				"<Emoji: Smiling face with open mouth and cold sweat>" : "😅",
				"<Emoji: Smiling face with open mouth and tightly-closed eyes>" : "😆",
				...
				"<Emoji: Face throwing a kiss>" : "😘",
				"<Emoji: Kissing face>" : "😗",
				"<Emoji: Kissing face with smiling eyes>" : "😙",
				"<Emoji: Kissing face with closed eyes>" : "😚",
				"<Emoji: Crazy face>" : "🤪",
				"<Emoji: Face with stuck-out tongue and winking eye>" : "😜",
				"<Emoji: Face with stuck-out tongue and tightly-closed eyes>" : "😝",
				"<Emoji: Face with stuck-out tongue>" : "😛",
				"<Emoji: Money-mouth face>" : "🤑",
				"<Emoji: Smiling face with sunglasses>" : "😎",
				"<Emoji: Nerd face>" : "🤓",
				"<Emoji: Face with monocle>" : "🧐",
				"<Emoji: Face with cowboy hat>" : "🤠",
				"<Emoji: Hugging face>" : "🤗",
				"<Emoji: Clown face>" : "🤡",
				"<Emoji: Smirking face>" : "😏",
				...
				"<Emoji: Tired face>" : "😫",
				"<Emoji: Weary face>" : "😩",
				"<Emoji: Face with look of triumph>" : "😤",
				"<Emoji: Face with open mouth>" : "😮",
				"<Emoji: Face screaming in fear>" : "😱",
				"<Emoji: Fearful face>" : "😨",
				"<Emoji: Face with open mouth and cold sweat>" : "😰",
				"<Emoji: Hushed face>" : "😯",
